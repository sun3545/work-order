      ...
      >
        <template slot="menuLeft">
          <el-button
            ...
            @click="handleAdd"
            size="small"
            v-if="permissions.generator_equipvery_add"
            >新 增</el-button
          >
          <br /><br />
        </template>
        <template slot-scope="scope" slot="menu">
          ...
          <el-button
            type="success"
            v-if="permissions.generator_equipvery_finish"
          ...
          >
          <el-button
            v-if="permissions.generator_equipvery_down"
            icon="el-icon-check"
            size="mini"
            plain
          ...
          <el-button
            type="primary"
            v-if="permissions.generator_equipvery_edit"
            icon="el-icon-edit"
            size="mini"
            plain
          ...
          <el-button
            type="danger"
            v-if="permissions.generator_equipvery_del"
            icon="el-icon-delete"
            size="mini"
            plain
...
import {
  ...
  delObj,
  getFinish
} from "@/api/basic/equipvery";
import { tableOption } from "@/const/crud/basic/equipvery";
...
export default {
  ...
  methods: {
    ...
    searchChange(params, done) {
      if (params.veryTime) {
        params.searchDate = params.veryTime;
        params.veryTime = undefined;
      }
      this.page.currentPage = 1;
      this.listQuery.current = 1;
      console.log("核查", params);
      this.getList(params);
      done();
    },
    getList(params) {

      ...
      >
        <template slot="menuLeft">
          <el-button
            ...
            @click="handleAdd"
            size="small"
            v-if="permissions.generator_equipcali_add"
            >新 增</el-button
          >
          <br /><br />
        </template>
        <template slot-scope="scope" slot="menu">
          ...
          <el-button
            type="success"
            v-if="permissions.generator_equipcali_finish"
          ...
          >
          <el-button
            v-if="permissions.generator_equipcali_down"
            icon="el-icon-check"
            size="mini"
            plain
          ...
          <el-button
            type="primary"
            v-if="permissions.generator_equipcali_edit"
            icon="el-icon-edit"
            size="mini"
            plain
          ...
          <el-button
            type="danger"
            v-if="permissions.generator_equipcali_del"
            icon="el-icon-delete"
            size="mini"
            plain
...
import {
  ...
  delObj,
  getFinish
} from "@/api/basic/equipcali";
import { tableOption } from "@/const/crud/basic/equipcali";
...
export default {
  ...
  methods: {
    ...
    searchChange(params, done) {
      if (params.caliTime) {
        params.searchDate = params.caliTime;
        params.caliTime = undefined;
      }
    ...
    handleSave: function(row, done) {
      ...
      addObj(row).then(data => {
        ...
        // console.log(131313, this.tableData);
        this.$message({
          showClose: true,
          message: "添加成功",
          type: "success"

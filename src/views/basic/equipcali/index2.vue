      ...
      >
        <template slot="menuLeft">
          <el-button
            ...
            @click="handleAdd"
            size="small"
            v-if="permissions.generator_equipinfo_add"
            >新增</el-button
          >
          <br /><br />
        </template>
        <template slot-scope="scope" slot="menu">
          ...
          <el-button
            type="info"
            v-if="permissions.generator_equipinfo_down"
            icon="el-icon-check"
            size="mini"
            plain
          ...
          <el-button
            type="primary"
            v-if="permissions.generator_equipinfo_edit"
            icon="el-icon-edit"
            size="mini"
            plain
          ...
          <el-button
            type="danger"
            v-if="permissions.generator_equipinfo_del"
            icon="el-icon-delete"
            size="mini"
            plain
        ...
        <template slot="status" slot-scope="scope">
          <el-tag :type="scope.row.status ? 'danger' : 'primary'">{{
            scope.label
          }}</el-tag>
        </template>
      </avue-crud>
...
import { tableOption } from "@/const/crud/basic/equipinfo";

<template>
  <div class="app-container pull-auto orderexec">
    <basic-container>
      <avue-crud
        ref="crud"
        :page="page"
      ...
      >
        <template slot="menuLeft">
          <el-button
            ...
            @click="handleAdd"
            size="small"
            v-if="permissions.generator_orderexec_add"
            >新 增</el-button
          >
          <br /><br />
        </template>
        <template slot-scope="scope" slot="menu">
          <el-button
            v-if="permissions.generator_orderexec_open"
            type="success"
            size="mini"
            icon="el-icon-open"
            plain
          ...
          >
          <el-button
            v-if="permissions.generator_orderexec_close"
            type="warning"
            size="mini"
          ...
          >
          <el-button
            v-if="permissions.generator_orderexec_down"
            icon="el-icon-check"
            size="mini"
            plain
          ...
          <el-button
            type="primary"
            v-if="permissions.generator_orderexec_edit"
            icon="el-icon-edit"
            size="mini"
            plain
          ...
          <el-button
            type="danger"
            v-if="permissions.generator_orderexec_del"
            icon="el-icon-delete"
            size="mini"
            plain
...
import {
  ...
  closeOrder,
  openOrder
} from "@/api/basic/orderexec";
import { remote } from "@/api/admin/dict";
import { tableOption } from "@/const/crud/basic/orderexec";
...
export default {
  ...
  methods: {
    ...
    searchChange(params, done) {
      //     if (params.execTime) {
      //     params.searchDate = params.execTime;
      //     params.execTime = undefined;
      //   }
